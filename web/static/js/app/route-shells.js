  ...
  return `
    <section class="feed-column user-profile-column" ${outletMain(`data-shell-main data-profile-shell="1" data-profile-pubkey="${pubkey}" data-profile-relays=""`)}>
      ...
      <div class="user-tabs profile-tabs">
        ...
        <input type="radio" name="user-tab" id="user-tab-replies" class="user-tab-state"><section class="user-tab-panel" id="user-panel-replies" data-user-fragment="replies"><div class="feed" data-profile-feed="replies">${profileFeedLoaderMarkup("replies")}</div><button class="load-more" data-load-more data-feed-url="${url.pathname}" data-fragment="replies" data-cursor="" data-cursor-id="" data-has-more="0" type="button" hidden>Load more</button></section>
